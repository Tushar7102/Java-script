...
let allproduct=[];
function Fetchdata() {
  fetch("https://shark-tank-json-server.onrender.com/pitches")
    .then((res) => res.json())
    .then((data) => {
      allproduct=data
      Cardlist(data)
...
function DeletePitch(id) {
  fetch(`https://shark-tank-json-server.onrender.com/pitches/${id}`, {
...
updatePitchBtn.addEventListener("click", () => {
  ...
  fetch(`https://shark-tank-json-server.onrender.com/pitches/${updatePitchIdInput.value}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
    },
  ...
  if (event.target.classList.contains("Add-cart-button")) {
    ...
    fetch(`https://shark-tank-json-server.onrender.com/pitches/${id}`)
      ...
      .then((data) => {
        ...
        fetch("https://shark-tank-json-server.onrender.com/cartpage", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
